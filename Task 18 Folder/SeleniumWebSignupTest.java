...
public class SeleniumWebSignupTest {
    ...
    public void InvalidEmail() throws InterruptedException {
        //Test3. Verify that user cannot signUp with Invalid Email
        ...
        //5. Enter username in the username button
        driver.findElement(By.xpath("//*[@id=\"user_username\"]")).sendKeys("shogo");
        //6. Enter an invalid email in the email field
    ...
    public void blankPassword() throws InterruptedException {
        //Test3. Verify that user cannot signUp with blank password
        //Clear the username field
        driver.findElement(By.xpath("//*[@id=\"user_username\"]")).clear();
        //Clear the email field
        driver.findElement(By.xpath("//*[@id=\"user_email\"]")).clear();
    ...
    public void blankUsername() throws InterruptedException {
        //Test3. Verify that user cannot signUp with blank username
        //Clear the username field
        driver.findElement(By.xpath("//*[@id=\"user_username\"]")).clear();
        //Clear the email field
        driver.findElement(By.xpath("//*[@id=\"user_email\"]")).clear();
